...
namespace Blacklamp.Invoice.Authentication.Tests
{
	public class AuthenticationServiceTests
	{
		...
		public async void For_UserAuth_Given_InvalidCredentials_Should_Return_Null()
		{
			...
			ILogger<UserService> loggerMock = Mock.Of<ILogger<UserService>>();
			...
			var serviceInTest = new UserService(mockAuthRepository.Object, mockJwtSettings.Object, loggerMock);
